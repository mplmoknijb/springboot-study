...
import cn.leon.bean.ColumnValue;
import cn.leon.bean.Table;
...
public class MybatisGenerator extends AbstractGenerator {
    ...
    private String mbgXmlPath = "generator.xml";
    ...
    protected void generateDomainConstants(String... tableNames) throws Exception {
        ...
        for (String name : tableNames) {
            ...
            moduleRoot = GeneratorHelper.formatPath(moduleRoot, config.getModuleName());
            ...
            String javaDir = moduleRoot + GeneratorConstants.MAIN_JAVA + GeneratorHelper.converterPackage(config.getRootPackage()) + "/constants/";
